            ...
            <MainLayout>
                <main className={styles.mainHomePage} >
                    <section className={styles.contentHomePage} >
                        ...
                        <p className={styles.homeTextContent} >Document your travels, one memory at a time. A digital diary for your wanderlust. Discover amazing places with us. Start your travel story today.</p>
                        <NavLink to="/travelMap" className={styles.navLink}>
